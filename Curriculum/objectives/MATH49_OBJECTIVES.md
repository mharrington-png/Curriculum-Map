...
## Review Objectives (`M49-FND`)

These objectives represent prerequisite content to diagnose and reinforce as needed. They are not assigned the same instructional priority as required Math 49 objectives.
...
## Required Unit 1: Function Operations, Composition, and Inverses (`M49-OPS`)
...
## Extension Unit 1: Additional Limit Concepts (`M49-LXE`)
...
## Extension Unit 2: Parametric Equations (`M49-PAR`)
...
## Extension Unit 3: Conic Sections (`M49-CON`)
...
## Additional Extension Topics Awaiting Objectives

Extension objectives for complex numbers, vectors, and polar topics should be added only after the department decides their intended Math 49 depth. Existing Math 32 extension objectives may be reused rather than duplicated.

## Review Status

- **Draft source:** Existing Math 49 course map and its OpenStax crosswalk
- **Faculty decisions needed:** unit order, objective granularity, expected depth of limits, and permanent-ID approval
- **Next mapping steps:** map supporting skills objective-by-objective and attach assessments, OpenStax exercises, and supplemental materials
