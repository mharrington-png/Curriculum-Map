# Math 32 Learning Objectives

These draft objectives follow the department standard: observable, one primary outcome, textbook-independent, and beginning with “I can.” IDs are intended to be permanent after faculty approval.

## Unit 1: Trigonometric Foundations (`M32-FND`)
...
## Unit 2: Periodic Functions and Modeling (`M32-GRF`)
...
## Unit 4: Non-Right Triangles (`M32-TRI`)
...
## Unit 5: Trigonometric Identities (`M32-IDN`)

- **M32-IDN-001:** I can rewrite trigonometric expressions using reciprocal and quotient identities, including `tan(theta) = sin(theta)/cos(theta)`.
...
## Extension Unit 6: Additional Trigonometric Identities (`M32-IDX`)
...
## Extension Unit 8: Polar Functions (`M32-PLX`)
...
## Extension Unit 9: Vectors (`M32-VEC`)
...
## Extension Unit 10: Parametric Equations (`M32-PAR`)
...
- **Draft source:** Math 32 workbook table of contents and instructional pages
- **Faculty decisions needed:** objective granularity and permanent-ID approval
- **Approved curriculum status:** Polar coordinates of points are required. Polar functions, additional identities, triangle area from SAS, vectors, and parametrics are extension material. Inverse-trigonometric evaluation is required.
- **Next mapping steps:** connect each objective to reusable skills, assessments, OpenStax, and Desmos resources
